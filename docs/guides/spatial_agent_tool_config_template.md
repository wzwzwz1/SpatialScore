...
- [`/disk/wangzhe/SpatialScore/docs/guides/tool_config.server.template.json`](/disk/wangzhe/SpatialScore/docs/guides/tool_config.server.template.json)
...
- VSI-Bench 评测说明：
  - [`/disk/wangzhe/SpatialScore/docs/guides/spatial_agent_vsibench.md`](/disk/wangzhe/SpatialScore/docs/guides/spatial_agent_vsibench.md)
- 可直接复制的 JSON 模板：
  - [`/disk/wangzhe/SpatialScore/docs/guides/tool_config.server.template.json`](/disk/wangzhe/SpatialScore/docs/guides/tool_config.server.template.json)
